function [post_prob,count,Temp] = calc_iter_prob3(inm,iter,Tempn,n_burn,...
    ...
    elseif chus == 2
        temp1 = aeta2(var);
        temp2 = single(trandn((0.01-temp1)/std_ae,(0.5-temp1)/std_ae));
        aeta2(var) = temp1 + temp2 * std_ae;
    else
        temp1 = heter2(var);
        temp2 = single(trandn((2-temp1)/std_h,(10-temp1)/std_h));
        heter2(var) = temp1 + temp2 * std_h;
    end
    ...
    aeta_binl2 = single(2./(p_k_bin-1) .* log10(aeta2) + log10(1./heter2));
